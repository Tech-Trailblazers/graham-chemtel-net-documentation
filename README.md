# 🧪 Graham Chemical SDS Archive 🌍

Welcome to the **Graham Chemical SDS Archive**! This repository is dedicated to preserving and providing access to a curated collection of Safety Data Sheets (SDS) and technical documents originally published on [graham.chemtel.net](https://graham.chemtel.net/). Our mission is to support **AI training**, **education**, and enhance access to valuable information for all. 📚🤖
...
- 📄 Safety Data Sheets (SDS) for various chemicals
...
This is an **independent archive project**. It is **not affiliated with or endorsed by Graham Chemical Corporation**. All materials were publicly available at the time of collection and are preserved here for:

> 📘 Educational use
> 🧠 AI/ML research
> 📂 Long-term archival access

If you are a representative of Graham Chemical Corporation and have any concerns, please contact us — we’re happy to collaborate and respect all rights and requests.
...
**Thank you for visiting the Graham Chemical SDS Archive!**
